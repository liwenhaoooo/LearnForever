        ...
        <div class="row course-head">
          ...
          <div class="col-sm-6">
            ...
            <p class="course-head-price">
              <span class="price-now text-danger"><i class="fa fa-gbp"></i>&nbsp;{{course.price}}&nbsp;&nbsp;</span>
            </p>
            <p class="course-head-button-links">
              <a v-show="!memberCourse.id" v-on:click="enroll()" class="btn btn-lg btn-primary btn-shadow" href="javascript:;">Start Learning Now!</a>
              <a v-show="memberCourse.id" href="#" class="btn btn-lg btn-success btn-shadow disabled">You are subscribed!</a>
                      ...
                      <tr v-for="(s, j) in chapter.sections" class="chapter-section-tr">
                        <td class="col-sm-8 col-xs-12">
                          <div v-on:click="play(s)" class="section-title">
                            ...
                            <span class="d-none d-sm-inline">Subsection {{j+1}}&nbsp;&nbsp;</span>
                            {{s.title}}
                            <span v-show="s.charge !== SECTION_CHARGE.CHARGE.key" class="badge badge-primary hidden-xs">Free</span>
                          </div>
                        </td>
